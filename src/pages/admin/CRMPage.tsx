...
const initialLeads: Record<string, Lead[]> = {
  new: [
    { id: '1', name: 'Maria Silva', email: 'maria@email.com', phone: '(11) 99999-1111', value: 'R$ 500', stage: 'new', lastContact: 'Hoje' },
    { id: '2', name: 'João Pereira', email: 'joao@email.com', phone: '(11) 99999-2222', value: 'R$ 800', stage: 'new', lastContact: 'Ontem' },
  ],
  contact: [
    { id: '3', name: 'Ana Costa', email: 'ana@email.com', phone: '(11) 99999-3333', value: 'R$ 1.200', stage: 'contact', lastContact: '2 dias' },
  ],
  proposal: [
    { id: '4', name: 'Carlos Santos', email: 'carlos@email.com', phone: '(11) 99999-4444', value: 'R$ 2.500', stage: 'proposal', lastContact: 'Hoje' },
    { id: '5', name: 'Patricia Lima', email: 'patricia@email.com', phone: '(11) 99999-5555', value: 'R$ 750', stage: 'proposal', lastContact: '3 dias' },
  ],
  negotiation: [
    { id: '6', name: 'Roberto Alves', email: 'roberto@email.com', phone: '(11) 99999-6666', value: 'R$ 3.000', stage: 'negotiation', lastContact: 'Hoje' },
  ],
  closed: [
    { id: '7', name: 'Fernanda Reis', email: 'fernanda@email.com', phone: '(11) 99999-7777', value: 'R$ 1.800', stage: 'closed', lastContact: 'Ontem' },
  ],
};
