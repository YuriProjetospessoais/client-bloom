...
import { Bell, Phone, Check, X, Clock, Calendar } from 'lucide-react';
...
const mockAlerts: Alert[] = [
  ...
  { id: 4, client: 'Roberto Alves', procedure: 'Consulta', lastVisit: '2025-09-10', daysAgo: 127, phone: '(11) 99999-4444', status: 'pending' },
  { id: 5, client: 'Patricia Lima', procedure: 'Tratamento Capilar', lastVisit: '2025-11-25', daysAgo: 51, phone: '(11) 99999-5555', status: 'ignored' },
];
...
export default function AlertsPage() {
  ...
  const ignoredAlerts = alerts.filter(a => a.status === 'ignored');
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Clientes que precisam ser contatados para retorno</p>
        </div>
      ...
      <Tabs defaultValue="pending" className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-3">
          ...
          <TabsTrigger value="ignored" className="gap-2">
            <X className="w-4 h-4" />
            Ignorados ({ignoredAlerts.length})
          </TabsTrigger>
        </TabsList>
