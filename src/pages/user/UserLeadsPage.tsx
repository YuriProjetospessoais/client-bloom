...
const mockLeads = [
  { id: 1, name: 'João Ferreira', email: 'joao@email.com', phone: '(11) 99999-1111', source: 'Instagram', stage: 'contact', createdAt: '2026-01-15' },
  { id: 2, name: 'Camila Souza', email: 'camila@email.com', phone: '(11) 99999-2222', source: 'Indicação', stage: 'proposal', createdAt: '2026-01-14' },
  { id: 3, name: 'Bruno Costa', email: 'bruno@email.com', phone: '(11) 99999-3333', source: 'Google', stage: 'negotiation', createdAt: '2026-01-13' },
  { id: 4, name: 'Julia Ferreira', email: 'julia@email.com', phone: '(11) 99999-4444', source: 'Site', stage: 'closed', createdAt: '2026-01-10' },
];
